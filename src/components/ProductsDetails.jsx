...
const ProductDetails = () => {
     ...
     const HandleAddToWishlist = () => {
          if (!user) {
               Swal.fire({
                    title: language === "az" ? "Daxil olmaq tələb olunur" : "Login Required",
                    text: language === "az"
                         ? "İstək siyahısına məhsul əlavə etmək üçün daxil olmalısınız."
                         : "You must be logged in to add items to your wishlist.",
                    icon: "warning",
                    showCancelButton: true,
                    confirmButtonText: language === "az" ? "Daxil ol" : "Login",
                    cancelButtonText: language === "az"
                         ? "Daxil olmadan davam et"
     ...
     const toggleWishlist = () => {
          ...
          if (isAlreadyAdded) {
               ...
               Swal.fire(
                    language === "az" ? "İstək siyahısından çıxarıldı" : "Removed from Wishlist",
                    language === "az"
               ...
               Swal.fire(
                    language === "az" ? "İstək siyahısına əlavə olundu" : "Added to Wishlist",
                    language === "az"
                         ? "Məhsul istək siyahınıza əlavə olundu."
     ...
     const addBasket = () => {
          if (!user) {
               Swal.fire({
                    title: language === "az" ? "Daxil olmaq tələb olunur" : "Login Required",
                    text: language === "az"
                         ? "Səbətə əlavə etmək üçün əvvəlcə daxil olun."
          ...
          if (count > 0) {
               ...
               Swal.fire(
                    language === "az" ? "Səbətə əlavə olundu" : "Added to Basket",
                    language === "az"
                         ? "Məhsul səbətinizə əlavə olundu."
               ...
               Swal.fire(
                    ...
                    language === "az"
                         ? "Məhsul sayı 0-dan çox olmalıdır."
                         ...
                         <div className="product-detail-main">
                              ...
                              <div className='colors d-flex flex-column justify-content-between gap-4' >
                                   <div className="colors-media d-flex flex-column gap-1 justify-content-between ">
                                        <p className="color"> {colors?.length ? colors.join(", ") : "N/A"}</p>
                              ...
                              <div className='payment-container d-flex flex-column gap-3'>
                                   <div className="payment-stock-warning">
                                        <div className="circle-cont d-flex align-items-center gap-1">
                                             ...
                                             <p className='mb-0'>
                                                  <StaticLang en="In stock, ready to ship today" az="Anbarda var, bu gün göndərilməyə hazırdır" />
                                             </p>

                                        </div>
                                        <p>
                                             <StaticLang
                                                  en="Hurry! Express shipping available! Order within "
                                                  az="Tələsin! Ekspress çatdırılma mövcuddur! Sifariş verin "
                                             />
                                             <b>6Hrs 37Mins</b>
                                        </p>
                                        <div>
                                   ...
                                   <div>
                                        <button onClick={addBasket} className='add-to-cart-btn d-flex justify-content-between align-items-center'><StaticLang en="Add To Cart" az="Səbətə At" />
                                   ...
                                   <ul className="delivery-details d-flex flex-column my-2">
                                        <li className='d-flex align-items-center gap-2'>
                                             <i className="fa-regular fa-credit-card" width={25}></i>
                                             <StaticLang en="Localized Currencies and Payments." az="Yerli valyutalar və ödəniş üsulları." />
                                        </li>
                                        <li className='d-flex align-items-center gap-2'>
                                             <i className="fa-solid fa-truck-ramp-box" width={25}></i>
                                             <StaticLang en="Fast, Secure and Tracked DPD Delivery." az="Sürətli, təhlükəsiz və izlənilə bilən DPD çatdırılması." />
                                        </li>
                                        <li className='d-flex align-items-center gap-2'>
                                             <i className="fa-brands fa-whatsapp" width={25} style={{ fontSize: "22px" }}></i>
                                             <StaticLang en="WhatsApp Support Available." az="WhatsApp dəstəyi mövcuddur." />
                                        </li>
                                   </ul>
                                   ...
                                   <div className="unboxing-exp bg-dark">
                                        ...
                                        <div className='textt'>
                                             <h4 className='text-light'>
                                                  <StaticLang en="Your Unboxing Experience" az="Unboxing Təcrübəniz" />
                                             </h4>
                                             <p className='text-light'>
                                                  <StaticLang
                                                       en="Our exclusive Mercedes-AMG F1 packaging is tailored to each product, featuring various formats to ensure your purchase is protected and secure."
                                                       az="Eksklüziv Mercedes-AMG F1 qablaşdırmamız hər bir məhsula uyğunlaşdırılıb və alışınızın təhlükəsizliyini təmin etmək üçün müxtəlif formatlarda təqdim olunur."
                                                  />
                                             </p>
                                        </div>
                                   </div>
                              ...
                              <div className="description">
                                   <a data-bs-toggle="collapse" href="#collapseDescription" role="button" aria-expanded="false" aria-controls="collapseDescription" className=' d-flex justify-centent-between align-items-center gap-2'><StaticLang en="Description" az="Təsvir" />
                                   ...
                                   <hr />
                                   <a data-bs-toggle="collapse" href="#collapseMerchandise" role="button" aria-expanded="false" aria-controls="collapseMerchandise" className=' d-flex justify-centent-between align-items-center gap-2'><StaticLang en="Official Merchandise" az="Rəsmi məhsul" />
                                        <svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 6 5">
                                             <path d="M2.56699 4.25c.19245.33333.67357.33333.86602 0l1.73205-3C5.35751.916667 5.11695.5 4.73205.5h-3.4641C.883049.5.642487.916667.834937 1.25l1.732053 3Z" fill="currentColor" />
                                        </svg>
                                   </a>
                                   <div className="collapse " id='collapseMerchandise'>
                                        <div className='collapse-container'>
                                             <p>
                                                  <StaticLang
                                                       en="Official Licensed Mercedes-AMG Petronas Formula One Team Merchandise."
                                                       az="Rəsmi lisenziyalı Mercedes-AMG Petronas Formula One Komandası məhsulları."
                                                  />
                                             </p>
                                             <p>
                                                  <StaticLang
                                                       en="Ordering from the Official Store means you're purchasing directly from the Team, ensuring that you receive 100% authentic merchandise."
                                                       az="Rəsmi mağazadan sifariş vermək, məhsulu birbaşa komandadan aldığınız və 100% orijinal məhsul əldə etdiyiniz deməkdir."
                                                  />
                                             </p>
                                        </div>
                                   </div>
