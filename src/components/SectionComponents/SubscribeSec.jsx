...
const SubscribeSec = () => {
  ...
  const placeholderforsub = language === 'az' ? 'E-poçt ünvanınızı daxil edin' : 'Enter your email address';
  return (
    <div className='subs-container d-flex flex-column align-items-center '>
    <h2 className="Newsletter-Title">
  <StaticLang en="Be a part of the Team" az="Komandanın bir hissəsi ol" />
</h2>
<p className="Newsletter-Text">
  <StaticLang en="Sign up for the latest store news, launches and exclusive offers" az="Ən son mağaza xəbərləri, buraxılışlar və eksklüziv təkliflər üçün qeydiyyatdan keç" />
</p>


      <div className="Newsletter-Form d-flex flex-column align-items-center">
        <form className='form'>
        <input type="email" placeholder={placeholderforsub} />
  ...
  <StaticLang
    en="By signing up you agree to our Terms & Conditions. You can unsubscribe at anytime you wish."
    az="Qeydiyyatdan keçməklə Şərtlər və Qaydalarımızla razılaşırsınız. İstədiyiniz zaman abunəliyi ləğv edə bilərsiniz."
  />
</p>
