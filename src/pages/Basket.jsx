        ...
        {products.length === 0 ? (
          <div>
            <div className="empty-basket">
              <p className='mb-4'>
                <StaticLang en="Add something to the basket!" az="Səbətə bir şey əlavə edin!" />
              </p>
              <NavLink to="/products" className="d-flex justify-content-center align-items-center">
                <button className="checkout btn btn-primary">
                  <StaticLang en="Go to Products" az="Məhsullara Bax" />
                </button>
              </NavLink>
            </div>
            <h2 className='text-light text-center py-5 h1 fw-medium'>
              <StaticLang en="Maybe try these..." az="Bunlara da baxa bilərsiniz..." />
            </h2>
            <TrendingSlider />
          </div>
        ) : (
          <div className='cart-card-container-basket'>
            ...
            <div className="checkout-section">
              <div className="total-amount">
                <StaticLang en="Total Amount:" az="Cəmi məbləğ:" /> {totalAmount.toFixed(2)} AZN
              </div>
              <NavLink to="/checkout">
                <button className="checkout">
                  <StaticLang en="Checkout" az="Sifarişi Tamamla" />
                </button>
              </NavLink>
            </div>
          </div>
